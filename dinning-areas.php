...
<html lang="en-US">
    ...
    <head>
        ...
        <style id="nuss-style-inline-css">
            .page-title-bg {
                background-image: url(http://starehe.codeisystems.co.ke/images/property7.png) !important;
            }
                ...
                <div class="page-title-inner" style="padding-top: 180px; padding-bottom: 80px;">
                    ...
                    <div class="container">
                        <div class="row row-xs-center">
                            <div class="col-md-12">
                                <div class="page-title-heading"><h1 class="heading heading-font">kitchen & dinning areas</h1></div>
                            </div>
                        </div>
                    </div>
                </div>
